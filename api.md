...
```json
{
	"shortUrl": "https://sml-nu.vercel.app/abc123"
}
```
...
```bash
curl -X POST https://sml-nu.vercel.app/api/shorten \
...
1. Create a new POST request to `https://sml-nu.vercel.app/api/shorten`
...
const response = await fetch(
	"https://sml-nu.vercel.app/api/shorten",
	{
		method: "POST",
		headers: {
			"Content-Type": "application/json",
